              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Listado de Asociados <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button><a href="../reportes/rptsocios.php"><button class="btn btn-info">Reporte</button></a></h1>
                    ...
                    <div class="panel-body"  id="formularioregistros">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="nsocio" id="nsocio" maxlength="100" placeholder="N° de Asociado" required>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
