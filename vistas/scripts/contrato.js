...
function init(){
	...
	$.post("../ajax/contrato.php?op=selectSocio", function(r){
        $("#idsocio").html(r);
...
function mostrar(idcontrato)
{
	$.post("../ajax/contrato.php?op=mostrar",{idcontrato : idcontrato}, function(data, status)
	{
