...
// Client address
function addClientAdresse($nombre,$tipo_documento,$num_documento,$direccion,$telefono,$fecha)
{
	$r1     = $this->w - 180;
	$r2     = $r1 + 68;
	$y1     = 40;
	$this->SetXY( $r1, $y1);
	$this->SetFont( "Arial", "B", 12);
	$this->MultiCell( 60, 4, "Asociado");
	$this->SetXY( $r1, $y1+5);
	$this->SetFont( "Arial", "", 12);
	$this->MultiCell( 150, 4, $nombre);
	$this->SetXY( $r1, $y1+10);
